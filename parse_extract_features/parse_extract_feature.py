...
def parse_one_game(Filename, one_game_group, csv_object, LOS, *map_args):
    ...
    Filename_str = '_'.join(item for item in parts)
    ...
    path = os.path.join('../data/feature_data/')
...
if __name__ == '__main__':
    ...
    # spatial tensors(空间特征):play's colour 1, friendly 6, enemy 6, observe 2, map 4,
    #                           end_pos 6, all is 25*66*51  地图大小3366
    # attribute vectors(全局特征):stage 20, city 4, friendly 23*6, enemy 23*6,  win 1, all is 301 属性特征 301bit
    # actxion 14*6, no_act 1  all is 85
